...
const SignupForm = () => {
  ...
  return (
    <>
<form className='m-auto my-16 max-w-[500px] p-8 bg-richblack-800 border-2 shadow-md rounded-md'>
  {loading ? (
    <Loader />
  ) : (
    <>
      <h2 className='text-center mb-4 text-richblack-5'>Welcome user, please signup here</h2>
      <div className="mb-4">
        <label htmlFor="name" className="text-richblack-5 block mb-1 after:content-['*'] after:ml-0.5 after:text-red-500">Name</label>
        <Input
          type="text"
          name="name"
          id="name"
